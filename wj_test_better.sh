...
#SBATCH -e logs/wj_easy_GloVe_testing.err
#SBATCH -o logs/wj_easy_GloVe_testing.out
...
python -u test_agent.py --pretrained_model './results/simple_twc_glove_5runs_100episodes_3hsize_0.0eps_easy_direct_cdc_0runId(5).pt'
